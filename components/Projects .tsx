...
const Projects: React.FC<ProjectsProps> = ({ darkMode = false }) => {
  ...
  const categories = ["All", "Web App", "Mobile App", "DevOps", "Blockchain"];
            ...
            >
              ...
              {project.featured && (
                <div className="absolute top-4 left-4 z-10">
                  <div className="flex items-center space-x-1 px-3 py-1.5 bg-gradient-to-r from-yellow-500 to-orange-500 rounded-full text-white text-xs font-semibold shadow-lg">
